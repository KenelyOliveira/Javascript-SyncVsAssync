var print = function print(mensagem, isTitulo) {
  var adiciona = function adiciona(elemento) {document.body.appendChild(elemento);};
  var texto = function texto() {return document.createTextNode("> " + mensagem);};
  var titulo = function titulo() {return document.createTextNode("##### " + mensagem);};
  var quebra = function quebra() {return document.createElement("br");};

  if (isTitulo)
  adiciona(titulo());else
...
/**********
   ...
   **********/
var sincrono = function sincrono() {
...
**********/
var assincrono = function assincrono() {
  var funcao2 = function funcao2() {
    setTimeout(function () {
...
assincronoComPromisse = function assincronoComPromisse() {
  var funcao3 = function funcao3() {
  ...
  var funcao1 = function funcao1() {
    ...
    }).then(function (res) {return print(res);}).
    catch(function (err) {return print(err);});
